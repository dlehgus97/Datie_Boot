    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                .authorizeRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/admin/today").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/admin/category").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/admin/age").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/admin/time").permitAll()
